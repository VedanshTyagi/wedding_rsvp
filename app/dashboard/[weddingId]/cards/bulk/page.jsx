                ...
                {Object.entries(STYLES).map(([key, s]) => (
                  <button key={key} type="button" onClick={() => setCurStyle(key)}
                    className={`text-xs py-2 px-1 rounded-lg border transition text-center
                      ${curStyle === key ? "border-crimson bg-crimson/10 text-crimson" : "border-sand text-[#6f5a4a] hover:border-[#c9a96e]"}`}>
                    {s.label.split(" ")[0]}
                  </button>
                ))}
              </div>
                ...
                {Object.entries(FONTS).map(([key, f]) => (
                  <button key={key} type="button" onClick={() => setCurFont(key)}
                    ...
                    className={`py-2 text-sm rounded-lg border transition
                      ${curFont === key ? "border-crimson bg-crimson/10 text-crimson" : "border-sand text-[#6f5a4a] hover:border-[#c9a96e]"}`}>
                    {f.label}
                  </button>
                ))}
              </div>
