          ...
          <div ref={cardRef}
            ...
            <div style={{
              ...
              {motifs.shloka && (custom.shloka || "ॐ गणेशाय नमः") && (
                <div style={{
                  color: ac, fontSize: "13px", textAlign: "center",
              ...
              {/* Subtitle */}
              <div style={{
                color: ac, fontSize: "11px", letterSpacing: `${letterSpacing + 3}px`,
              ...
              {/* Names */}
              <div style={{
                color: nc, fontFamily: font, fontSize: `${nameSize}px`,
              ...
              <div style={{
                color: ac, fontFamily: font, fontSize: "18px",
              ...
              {guestFns.map((fn, i) => (
                <div key={fn.id} style={{
                  ...
                  <div style={{
                    color: ac, fontSize: "11px", letterSpacing: "3px",
              ...
              {wedding.venue && (
                <div style={{
                  color: nc, fontSize: "11px", textAlign: "center",
              ...
              {motifs.dressCode && wedding.dress_code && (
                <div style={{
                  color: ac, fontSize: "10px", textAlign: "center",
              ...
              {custom.extraLine && (
                <div style={{
                  color: ac, fontSize: "11px", textAlign: "center",
